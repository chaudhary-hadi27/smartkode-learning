...
import { intermediateCourses, Course } from "@/data/intermediateCourses";

export default function IntermediateCourses() {
  ...
  const CourseCard = ({ course }: { course: Course }) => (
    ...
    >
      ...
      <p className="text-gray-400 text-base whitespace-pre-wrap">{course.description}</p>
          ...
          {course.longDescription && (
            <div className="prose prose-invert max-w-none text-[17px] leading-relaxed break-words whitespace-pre-line">
              <ReactMarkdown
                components={{
                  h2: ({ ...props }) => (
                    <h2 className="text-2xl font-semibold text-white border-b border-white pb-2 my-4" {...props} />
                  ),
                  h3: ({ ...props }) => (
                    <h3 className="text-xl font-semibold text-white mt-8 mb-2 border-b border-gray-700 pb-1" {...props} />
                  ),
                }}
              >
                {course.longDescription}
  ...
  return (
    <>
      <Head>
        <title>Intermediate Courses | Real-World Web & AI Projects</title>
        <meta
          name="description"
          content="Advance your coding journey with intermediate-level courses in web development, data structures, and AI — all with real-world projects."
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Intermediate Courses | SmartKode Learning" />
        <meta
          property="og:description"
          content="Take your skills to the next level with intermediate programming courses designed for hands-on project building."
        />
      ...
      <div className="relative px-4 sm:px-6">
        <section
          ...
          aria-labelledby="intermediate-courses-heading"
        >
          <h2
            id="intermediate-courses-heading"
          ...
          >
            ...
            <span className="text-lg sm:text-xl font-normal text-gray-400">
              Real Projects – Advance Your Skills
            </span>
          </h2>
